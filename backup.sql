...
--
-- Dumping data for table `philanthropist`
--

LOCK TABLES `philanthropist` WRITE;
/*!40000 ALTER TABLE `philanthropist` DISABLE KEYS */;
/*!40000 ALTER TABLE `philanthropist` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-04-07 11:08:25
